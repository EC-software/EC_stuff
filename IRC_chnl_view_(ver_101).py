"""
    ...
    ver. 1.0.0 build 2014-12-30 17:00 - First working version
        tested on Python 2.7.8 / Linux 3.17.7 x86_64 
    ver. 1.0.1 build 2014-12-30 18:24
        Added PING/PONG handling, to stay alive 
"""
...
while bol_go:
    ...
    # Handle PING/PONG to stay alive
    if "PING" in str_recv:
        if str_recv[:6] == "PING :": # Its a genuen PING message
            str_pong_reply = str_recv[6:].strip()
            #print "# PING/PONG"
            s.send("PONG :%s\r\n" % str_pong_reply)
